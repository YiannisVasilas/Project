...
model.reactions.get_by_id('BIOMASS_aerobic').lower_bound = 0.3
...
en =np.array( production_envelope (model,["DM_amd","EX_nh4_e"],objective= "DM_amd", carbon_sources= 'EX_glc__D_e',points = 1000))
np.savetxt('Product_stain_.csv',en,fmt='%s')
print (en)
