...
for r in Carbon_source:
        r.lower_bound = -100
        r.upper_bound = 14'''
#MEP closed DXRI,CMS,CMK,n_MCS2,IDS1,IDS2
model.reactions.get_by_id("DXRI").lower_bound = 0
model.reactions.get_by_id("DXRI").upper_bound = 0
model.reactions.get_by_id("CMK").lower_bound = 0
model.reactions.get_by_id("CMK").upper_bound = 0
model.reactions.get_by_id("CMS").lower_bound = 0
model.reactions.get_by_id("CMS").upper_bound = 0
model.reactions.get_by_id("n_MCS2").lower_bound = 0
model.reactions.get_by_id("n_MCS2").upper_bound = 0
model.reactions.get_by_id("IDS1").lower_bound = 0
model.reactions.get_by_id("IDS1").upper_bound = 0
model.reactions.get_by_id("IDS2").lower_bound = 0
model.reactions.get_by_id("IDS2").upper_bound = 0
...
np.savetxt('PG1.csv',en,fmt='%s')
np.savetxt('PG1FVA.csv',FVA,fmt='%s')
print (en)
