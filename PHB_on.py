...
Media_Componets= [Potassium,Calcium,Phosphate,Sulfate,Zinc,Iron,Magnesium,Copper,Cobalt,Nicotin ,Thiamine, Biotin]
...
model.reactions.get_by_id('DM_phb').upper_bound = 1000
model.reactions.get_by_id('DM_phb').lower_bound = -1
...
#cobra.io.write_sbml_model( model, "PGI.xml", use_fbc_package=False)

en =np.array( production_envelope (model,["DM_ipdp","EX_glc__D_e"],objective= "BIOMASS_aerobic", carbon_sources= 'EX_glc__D_e',points = 200))
np.savetxt('Product_glc_Bio_obj_PHB.csv',en,fmt='%s')
